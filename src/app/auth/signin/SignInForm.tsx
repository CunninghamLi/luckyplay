...
export default function SignInForm({ callbackUrl }: { callbackUrl: string }) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // Let NextAuth set the cookie and redirect (prevents race loops)
    ...
    // If redirect is blocked for some reason, show a message
    if (res?.error) setMsg("Invalid credentials");
  }
